    ...
    public partial class criacaoDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VeiculiId = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Veiculos", x => x.VeiculiId);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "300eb756-8a15-4e48-93e0-75b508cfee4c", "fa4dc3a3-4c5d-43ee-9b99-6eb7a2238cb2", "Morador do Prédio", "Morador", "MORADOR" },
                    { "8d2efd86-7d39-4fb0-b81b-13dda44fe19e", "1d889e30-7251-43cd-8fbc-d0508eaf0ec5", "Sindico do Prédio", "Sindico", "SINDICO" },
                    { "5914b12b-2126-4ef3-bd86-8856813a3298", "c8ca0c3a-0768-4eec-878e-fe2b3cf03692", "Administrador do Prédio", "Administrador", "ADMINISTRADOR" }
                });
